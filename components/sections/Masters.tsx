        ...
        >
          {masters.map((master) => (
            <motion.article
              ...
              className="group relative w-[min(82vw,340px)] shrink-0 snap-center overflow-hidden border border-white/[0.06] bg-gradient-to-b from-[#0a0a0a] to-[#030303] transition-all duration-500 ease-out md:w-auto md:hover:border-[#E50914]/40"
            >
              {/* Top glossy rim */}
              ...
              {/* Portrait - taller aspect ratio to keep face clear */}
              ...
              {/* Bottom content - positioned at absolute bottom */}
              <div className="absolute inset-x-0 bottom-0 z-[3] flex flex-col gap-4 bg-gradient-to-t from-black via-black/95 to-transparent p-5 pt-12 md:p-6 md:pt-16">
                {/* Name and role - clean and simple */}
                <div>
