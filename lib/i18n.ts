      ...
      categories: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              duration: "1 год",
              price: "800–1100 ₴",
              blurb: "Комфортна стрижка для дітей.",
            },
            {
              name: "Стрижка під насадку",
              duration: "40–45 хв",
              price: "700–900 ₴",
              blurb: "Рівна довжина та чистий контур.",
            },
            {
              name: "Стрижка на подовжене волосся",
              duration: "1 год 30 хв",
              price: "900–1300 ₴",
              blurb: "Точна робота з довжиною та текстурою.",
            },
            {
              name: "Моделювання / корекція",
              duration: "30–40 хв",
              price: "500–800 ₴",
              blurb: "Підтримка форми та акуратний фініш.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              name: "Стрижка + стрижка бороди та вусів",
              duration: "2 год",
              price: "1550–2100 ₴",
            ...
            },
            {
              ...
              duration: "2 год",
              price: "1600–2200 ₴",
              blurb: "Стрижка для батька та сина за один візит.",
            },
          ],
        },
        {
      ...
      categories: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              duration: "1h",
              price: "800–1100 ₴",
              blurb: "A comfortable cut for kids.",
            },
            {
              name: "Buzz cut",
              duration: "40–45 min",
              price: "700–900 ₴",
              blurb: "Even length and a clean outline.",
            },
            {
              name: "Long haircut",
              duration: "1h 30m",
            ...
            },
            {
              ...
              duration: "30–40 min",
              price: "500–800 ₴",
              blurb: "Shape maintenance and a neat finish.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          priceRange: "from 1550 ₴",
          imageAlt: "Full barber grooming service",
          items: [
            {
              name: "Haircut + beard and mustache trim",
              duration: "2h",
              price: "1550–2100 ₴",
              blurb: "Head and beard in one rhythm.",
            },
            {
              name: "Dad and son combo haircut",
              duration: "2h",
              price: "1600–2200 ₴",
              blurb: "Haircuts for father and son in one visit.",
            },
          ],
        },
        {
